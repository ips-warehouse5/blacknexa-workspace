      ...
      <View style={styles.body}>
        ...
        <View style={styles.footer}>
          <View style={styles.verifiedRow}>
            <BadgeCheck size={13} color={isVerified ? Colors.emerald : Colors.textMute} />
            <Text style={[styles.verifiedText, !isVerified && { color: Colors.textMute }]}>
              {isVerified ? "Fact-Verified" : "Pending"}
            </Text>
            <View style={[styles.sourceCountBadge, !isVerified && styles.sourceCountBadgePending]}>
              <Link2 size={9} color={isVerified ? Colors.emerald : Colors.textMute} />
              <Text style={[styles.sourceCountText, !isVerified && { color: Colors.textMute }]}>
...
const styles = StyleSheet.create({
  ...
  imageWrap: { height: 180, backgroundColor: Colors.surface2 },
