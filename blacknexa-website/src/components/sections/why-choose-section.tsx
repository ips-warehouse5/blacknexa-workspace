...
export function WhyChooseSection() {
  return (
    <section aria-label="Why choose BlackNexa" className="bg-surface px-7 py-[clamp(80px,10vw,132px)]">
      <div className="mx-auto max-w-[1080px]">
        <SectionHeading
          ...
          maxWidth="660px"
        />
        <div className="mt-[clamp(40px,4.6vw,62px)] flex flex-col">
          {whyChoose.map((w) => (
            <div
              key={w.n}
              className="bn-reveal flex flex-wrap gap-[clamp(18px,3vw,48px)] border-t border-border py-[clamp(24px,2.6vw,32px)]"
            >
              <p className="w-14 flex-none font-serif text-2xl font-bold leading-none tabular-nums text-accent">
                {w.n}
              </p>
