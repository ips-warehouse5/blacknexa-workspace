...
export function ServicesSection() {
  return (
    <section id="services" className="bg-surface-elevated px-7 py-[clamp(52px,5.6vw,80px)]">
      <div className="mx-auto max-w-[1280px]">
        ...
        <div className="mt-[clamp(30px,3.4vw,44px)] grid grid-cols-1 gap-px overflow-hidden rounded border border-border bg-border md:grid-cols-2 lg:grid-cols-3">
          {services.map((s) => (
            <div key={s.title} className="bn-reveal flex flex-col bg-background px-6 pb-[30px] pt-[26px]">
