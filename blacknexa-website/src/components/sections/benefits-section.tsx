...
export function BenefitsSection() {
  return (
    <section aria-label="Platform benefits" className="px-7 py-[clamp(52px,5.6vw,80px)]">
      <div className="mx-auto max-w-[1280px]">
        ...
        <div className="mt-[clamp(28px,3.2vw,40px)] grid grid-cols-[repeat(auto-fit,minmax(268px,1fr))] gap-[18px]">
          {benefits.map((b) => (
            <div key={b.n} className="bn-reveal rounded-[5px] border border-border bg-surface px-[22px] pb-[26px] pt-6">
