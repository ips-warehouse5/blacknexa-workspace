...
export function WaitlistSection() {
  return (
    <section id="waitlist" className="px-7 py-[clamp(80px,10vw,132px)]">
      <div className="mx-auto flex max-w-[1180px] flex-wrap items-start gap-[clamp(32px,4.5vw,72px)]">
        <div className="bn-reveal min-w-[min(100%,300px)] max-w-[56ch] flex-[1_1_380px]">
          ...
          <p className="mt-6 text-pretty text-[clamp(1rem,1.2vw,1.1rem)] leading-[1.72] text-text-secondary">
            Waitlist members get the download alert the moment BlackNexa reaches the Apple App
            Store and Google Play, plus early access as features roll out to our global family.
          </p>
        </div>
