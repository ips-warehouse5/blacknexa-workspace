/**
 * Seed articles — mirrors the Expo `SEED_NEWS` set so the syndication feeds
 * have content from the first deploy. The News DO inserts these lazily on
 * first access if its table is empty.
 */

import type { NewsArticle } from "@/types/news.interface";
